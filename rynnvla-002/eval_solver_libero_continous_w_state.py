...
from libero_util.Chameleon_utils import get_action_Chameleon_dis_awm_ck_continous_action
                ...
                while t < max_steps + 10:
                    ...
                    try:
                        ...
                        if len(actions_ck) == 0:
                            import time
                            start = time.time()
                            dis_action = get_action_Chameleon_dis_awm_ck_continous_action(
                                self.model,
                                cur_img,
                                cur_wrist_img,
                                task_description,
                            ...
                            print('dis_action:',  dis_action)
                            print(time.time()-start, '11111111', len(dis_action))
